import { A as getDistances, B as randomInRangeValue, D as clamp, F as getRangeMax, H as isArray, I as getRangeMin, J as Vector, K as isObject, L as getRangeValue, N as getRandom, O as degToRad, S as OutModeDirection, V as setRangeValue, W as isNull, a as circleBounceDataFromParticle, c as executeOnSingleOrMultiple, d as getItemsFromInitializer, et as doublePI, g as itemFromSingleOrMultiple, h as itemFromArray, i as circleBounce, it as half, k as getDistance, m as isPointInside, ot as millisecondsToSeconds, p as isInArray, r as calculateBounds, s as deepExtend, st as originPoint, t as getLogger, u as getItemMapFromInitializer, v as safeDocument, z as parseAlpha } from "./LogUtils-CHBD7Nv0.js";
import "./browser-CxLw_du5.js";
import { _ as Circle, a as OptionsColor, c as loadOptionProperty, g as AnimationMode, h as OutMode, i as AnimatableColor, l as loadProperty, m as ParticleOutType, n as RangedAnimationValueWithRandom, o as RangedAnimationOptions, p as StartValueType, r as ValueWithRandom, t as ParticlesBounce, u as loadRangeProperty, v as Rectangle } from "./ParticlesBounce-CKXSg2KU.js";
import { t as RotateDirection } from "./RotateDirection-D96AavKe.js";
import { a as getLinkColor, c as getStyleFromRgb, d as rangeColorToHsl, h as AnimationStatus, l as hslToRgb, m as updateColor, n as colorMix, o as getLinkRandomColor, p as rgbToHsl, r as getHslAnimationFromHsl, s as getStyleFromHsl, u as hslaToRgba } from "./ColorUtils-C_1PKh-l.js";
import { d as Interactivity, i as mouseMoveEvent, p as DivType, u as InteractorType } from "./InteractivityConstants-D0nmXDyB.js";
...
var BlendPlugin = class {
	...
	async getPlugin(container) {
		const { BlendPluginInstance } = await import("./BlendPluginInstance-COqoGX9h.js");
...
var MovePlugin = class {
	...
	async getPlugin(container) {
		const { MovePluginInstance } = await import("./MovePluginInstance-JEMidzyF.js");
...
var InteractivityPlugin = class {
	...
	async getPlugin(container) {
		const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-BfDuQ8cR.js");
...
var minRestoreSpeed$1 = .001;
var maxRestoreSpeed$1 = 1;
var restoreEpsilon$1 = .5;
...
//#endregion
//#region node_modules/@tsparticles/interaction-external-bubble/browser/BubbleModifier.js
...
var Bubbler = class extends ExternalInteractorBase {
	...
	clear(particle, _delta, force) {
		if (this.#modifiers.get(particle)?.inRange && !force) return;
	...
	#process(particle, distMouse, timeSpent, data) {
		...
		if (container.bubble.durationEnd) {
			if (pObjBubble) {
				if (type === ProcessBubbleType.size) mod.radius = void 0;
				if (type === ProcessBubbleType.opacity) mod.opacity = void 0;
			}
		} else if (distMouse <= bubbleDistance) {
			if ((pObjBubble ?? pObj) !== bubbleParam) {
				const value = pObj - timeSpent * (pObj - bubbleParam) / bubbleDuration;
				if (type === ProcessBubbleType.size) mod.radius = value;
				if (type === ProcessBubbleType.opacity) mod.opacity = value;
			}
		} else {
			if (type === ProcessBubbleType.size) mod.radius = void 0;
			if (type === ProcessBubbleType.opacity) mod.opacity = void 0;
...
var minSpeed = 0;
var easingOffset = 1;
var minRestoreSpeed = .001;
var maxRestoreSpeed = 1;
var restoreEpsilon = .5;
...
//#endregion
//#region node_modules/@tsparticles/interaction-external-slow/browser/SlowModifier.js
...
var Slower = class extends ExternalInteractorBase {
	...
	clear(particle, _delta, force) {
		if (this.#modifiers.get(particle)?.enabled && !force) return;
	...
	reset(interactivityData, particle) {
		...
		const dist = getDistance(mousePos, particle.getPosition()), proximityFactor = dist / radius, slowFactor = slowOptions.factor;
...
function addLoadImageToEngine(engine) {
	...
	engine.loadImage ??= async (container, data) => {
		...
		try {
			...
			let imageFunc;
			if (data.replaceColor) imageFunc = downloadSvgImage;
...
var OverlapPlugin = class {
	id = "overlap";
	async getPlugin(container) {
		const { OverlapPluginInstance } = await import("./OverlapPluginInstance-OfMImgua.js");
...
var LinksPlugin = class {
	...
	async getPlugin(container) {
		const { LinkInstance } = await import("./LinkInstance-D67N8n_J.js");
