import { N as getRandom, Z as canvasTag, d as getItemsFromInitializer, g as itemFromSingleOrMultiple, n as EventType, nt as generatedFalse, rt as generatedTrue, t as getLogger, tt as generatedAttribute, u as getItemMapFromInitializer, v as safeDocument } from "./LogUtils-CHBD7Nv0.js";
...
var Engine = class {
	...
	async load(params) {
		...
		const { Container } = await import("./Container-CmIposCY.js"), id = params.id ?? domSourceElement?.id ?? `tsparticles${Math.floor(getRandom() * 1e4).toString()}`, { index, url } = params, currentOptions = itemFromSingleOrMultiple(url ? await getDataFromUrl({
